...
func newPool(opt *Option) *Pool {
	return &Pool{
		...
		body:        pool.NewPool[*icmp.Echo](0, opt.poolSize, func(_ int) *icmp.Echo { return &icmp.Echo{} }),
		msg:         pool.NewPool[*icmp.Message](0, opt.poolSize, func(_ int) *icmp.Message { return &icmp.Message{} }),
		msgBytes:    pool.NewPool[unsafe.Pointer](0, opt.poolSize, func(_ int) unsafe.Pointer { var b []byte; return unsafe.Pointer(&b) }),
		timeToBytesP: pool.NewPool[[]byte](opt.dataSize, opt.poolSize, func(size int) []byte {
