...
// StatisticsLog returns the statistics of the user_icmp. This can be run while the
// user_icmp is running, or after it is finished. OnFinish calls this function to
